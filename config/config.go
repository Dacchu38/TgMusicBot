...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		SupportGroup:      getEnvStr("SUPPORT_GROUP", "https://t.me/DVITTALBOTZ_DISSCUSSION"),
		SupportChannel:    getEnvStr("SUPPORT_CHANNEL", "https://t.me/DVITTALBOTZ"),
